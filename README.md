...
**Policy reference (PI Handbook style):** https://ayomide1400.github.io/msu-herd-survey/pi-handbook.html
...
| `pi-handbook.html` | The same framework content formatted as a formal institutional policy reference, styled to sit alongside a PI Handbook. |
...
- **PI Handbook citation** (`pi-handbook.html`, Section 2.3) — this quotes Morgan State's own PI Handbook (Part 5, Definition D). Replace with your institution's equivalent policy definition of R&D, if one exists, or omit the section if it doesn't.
...
This framework was developed to bring a consistent, document-anchored methodology to a process that, at most institutions, currently relies on informal judgment or sponsor-name shortcuts. The full rationale is in the [policy reference page](https://ayomide1400.github.io/msu-herd-survey/pi-handbook.html).
